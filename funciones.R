...
generar_graficos_fabricio <- function() {
  ...
  if (data_type == "anom") {
    ...
    if (variable == 'prcp') {
      ...
      if (fp$type == 'seasonal') {
        seqq <- c(0,25,50,100,150,200,300,500,750,1000,1500)
        seq.l <- c(0,25,50,100,150,200,300,500,750,1000,1500)
      }
    ...
    if (variable == 'prcp') {
      seqq <- c(0,1,25,50,100,150,200,250,300,400,600)
      seq.l <- c(0,1,25,50,100,150,200,250,300,400,600)
      if (fp$type == 'seasonal') {
        seqq <- c(0,50,150,300,500,750,1000,1500,2000,2500,5000)
        seq.l <- c(0,50,150,300,500,750,1000,1500,2000,2500,5000)
      }
      paleta <- c("#ff6634","#ff9934","#ffcc00","#ffffcd","#cdffcc",
                  "#9acc99","#34cc67","#33cc33","#019934","#006634",
                  "#00381d")
