...
spatial_domain:
  nla: 90   # Northernmost latitude
  sla: -90  # Southernmost latitude
  wlo: 1    # Westernmost longitude
  elo: 359  # Easternmost longitude

folder: "input2/predictors/"

files:
 - { file: "nmme_precip_Octic_11-1_1991-2021_2021-2022_1.txt", type: "seasonal", swap_years: true }
 - { file: "nmme_precip_Octic_11_1991-2020_2021_1.txt", type: "monthly", swap_years: true }
 - { file: "nmme_precip_Octic_1_1992-2021_2022_1.txt", type: "monthly", swap_years: true }
 - { file: "nmme_precip_Octic_12_1991-2020_2021_1.txt", type: "monthly", swap_years: true }
 - { file: "nmme_tmp2m_Octic_11-1_1991-2021_2021-2022_1.txt", type: "seasonal", swap_years: true }
 - { file: "nmme_tmp2m_Octic_11_1991-2020_2021_1.txt", type: "monthly", swap_years: true }
 - { file: "nmme_tmp2m_Octic_1_1992-2021_2022_1.txt", type: "monthly", swap_years: true }
 - { file: "nmme_tmp2m_Octic_12_1991-2020_2021_1.txt", type: "monthly", swap_years: true }
')
...
for (fp in config$files) {
  ...
  # Para pronosticos seasonales el primer año de entrenamiento es el primer año 
